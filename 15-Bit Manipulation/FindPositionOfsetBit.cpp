/*
	Problem : Given a number N, containing 1 set bit, find it's postion from LSB starting with index 1. if there are none or more than 1 set bits are there then return -1;
